...
- Archived all earlier specs and the previous changelog under `archive/`.
- Kept repository-native testing, review, and explicit external-action
  authorization as the sources of truth.
